...
public class RestSourceConnectorConfig extends AbstractConfig {
 ...
 // public static final String URL_GROUP_6 = "rest.api.list.6";
  ...
  public static final String REST_URL6_NODE_PATH_CONFIG = "node.path.6";
  private static final String REST_URL6_NODE_PATH_DOC = "node.path.6";
  
  public static final String REST_URL6_VAR_ELEMENT_CONFIG = "variable.element.6";
  private static final String REST_URL6_VAR_ELEMENT_DOC = "variable.element.6";
  ...
  public final String url6NodePath;
  public final String url6VariableElement;
  ...
  public RestSourceConnectorConfig(ConfigDef config, Map<String, String> parsedConfig) {
    ...
    this.url6NodePath = this.getString(REST_URL6_NODE_PATH_CONFIG);
    this.url6VariableElement = this.getString(REST_URL6_VAR_ELEMENT_CONFIG);
  ...
  public static ConfigDef conf() {
    return new ConfigDef()
        ...
        .define(REST_URL4_NODE_PATH_CONFIG, Type.STRING, null, Importance.HIGH, REST_URL4_NODE_PATH_DOC, URL_GROUP_1, 4 , Width.MEDIUM, REST_URL4_NODE_PATH_DOC)
        .define(REST_URL4_VAR_ELEMENT_CONFIG, Type.STRING, null, Importance.HIGH, REST_URL4_VAR_ELEMENT_DOC, URL_GROUP_1, 4, Width.MEDIUM, REST_URL4_VAR_ELEMENT_DOC)
        .define(REST_URL5_CONFIG, Type.STRING, null, Importance.HIGH, REST_URL5_DOC, URL_GROUP_1, 5, Width.MEDIUM, REST_URL5_DOC)
        .define(REST_URL5_NODE_PATH_CONFIG, Type.STRING, null, Importance.HIGH, REST_URL5_NODE_PATH_DOC, URL_GROUP_1,5, Width.MEDIUM, REST_URL5_NODE_PATH_DOC)
        .define(REST_URL5_VAR_ELEMENT_CONFIG, Type.STRING, null, Importance.HIGH, REST_URL5_VAR_ELEMENT_DOC, URL_GROUP_1, 5, Width.MEDIUM, REST_URL5_VAR_ELEMENT_DOC)
        .define(REST_URL6_CONFIG, Type.STRING, null, Importance.HIGH, REST_URL6_DOC, URL_GROUP_1, 6, Width.MEDIUM, REST_URL6_DOC)
        .define(REST_URL6_NODE_PATH_CONFIG, Type.STRING, null, Importance.HIGH, REST_URL6_NODE_PATH_DOC, URL_GROUP_1, 6, Width.MEDIUM, REST_URL6_NODE_PATH_DOC)
        .define(REST_URL6_VAR_ELEMENT_CONFIG, Type.STRING, null, Importance.HIGH, REST_URL6_VAR_ELEMENT_DOC, URL_GROUP_1, 6, Width.MEDIUM, REST_URL6_VAR_ELEMENT_DOC);
  }
